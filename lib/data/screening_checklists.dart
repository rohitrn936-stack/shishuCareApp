/// Each screening item now carries three fields instead of two:
/// - title: the domain (e.g. "Growth", "Hemoglobin")
/// - description: what to check / test
/// - redFlag: the red-flag finding that should trigger referral/escalation
///
/// universalRedFlags is a separate top-level list (not tied to any one age
/// band) -- shown on every screening regardless of age group, same as the
/// "Universal Red Flags" panel on the web checklist.
...
const Map<String, List<Map<String, String>>> screeningChecklists = {
  "Birth - 6 Weeks": [
    {
      "title": "Growth",
      "description":
          "Weight, length, head circumference plotted on WHO growth chart.",
      "redFlag":
          "Weight loss >10% from birth wt not regained by 2 wks; HC <32cm or >37cm.",
    },
    {
      "title": "Nutrition",
      "description": "Exclusive breastfeeding check, latch assessment.",
      "redFlag":
          "Poor feeding, no wet nappies in 6hrs, jaundice extending to palms/soles.",
    },
    {
      "title": "Blood Test",
      "description":
          "Newborn metabolic/TSH screening (where available), bilirubin if jaundiced.",
    ...
    },
    {
      ...
      "redFlag":
          "Fever, lethargy, poor cry, fast/laboured breathing, convulsions.",
    },
  ],
  ...
  "6 Weeks - 6 Months": [
    {
      ...
      "description":
          "Weight/length/HC monthly; breastfeeding + complementary feeding readiness at 6m.",
      "redFlag":
          "Weight faltering (crossing 2 centile lines), no interest in feeding.",
    },
    {
      "title": "Hemoglobin",
    ...
    },
    {
      "title": "Development",
      "description":
          "Social smile (6-8wk), head control (3-4m), rolling, reaching (6m).",
      "redFlag": "No social smile by 3m, no head control by 4m.",
    },
    {
      "title": "Vaccination",
      "description":
          "OPV/DTP/Hep B/Hib/PCV/Rota per schedule at 6, 10, 14 weeks.",
  ...
  "6 - 12 Months": [
    ...
    },
    {
      "title": "Development",
      "description":
          "Sitting (8m), crawling, pincer grasp, babbling -> first words (12m).",
  ...
  "1 - 2 Years": [
    ...
    },
    {
      "title": "Blood Glucose",
      "description":
          "Only if lethargy, poor feeding, or family history of metabolic disorder.",
      "redFlag": "Random glucose <45 or >200 mg/dL.",
    },
    {
      "title": "Hemoglobin",
      "description":
          "Hb at 12 months mandatory (India-specific high anemia burden).",
      "redFlag": "Hb <11 g/dL.",
    },
    {
      "title": "Development",
      "description":
          "Walking (12-15m), 2-word phrases (18m), pointing to show interest.",
  ...
  "2 - 3 Years": [
    ...
    },
    {
      "title": "Development",
      "description":
          "M-CHAT-R/F autism screen (24m), 2-word sentences, run/climb.",
      "redFlag":
          "Failed M-CHAT-R/F, regression of skills, no 2-word phrases by 24m.",
    },
    {
      "title": "Vision & Hearing",
  ...
  "3 - 5 Years": [
    ...
    },
    {
      "title": "Blood Glucose",
      "description":
          "If overweight + family history, or recurrent infections/excessive thirst.",
      "redFlag":
    ...
    },
    {
      "title": "Development",
      "description":
          "Speech clarity, counting, drawing, following 3-step instructions.",
      "redFlag":
          "Unintelligible speech at 4y, cannot follow simple instructions by 5y.",
    },
    {
      "title": "Vision & Hearing",
      "description":
          "Formal vision chart screening (age 3+), audiometry if available.",
    ...
    },
    {
      ...
      "description":
          "Caregiver-reported behavior, social interaction with peers.",
      "redFlag": "Social withdrawal, aggression, developmental regression.",
    },
  ],
};

/// Shown on every screening regardless of age band -- mirrors the
/// "Universal Red Flags" panel in the web checklist.
